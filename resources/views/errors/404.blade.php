...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @keyframes pulse {
            0%, 100% { box-shadow: 0 0 0 0 color-mix(in oklch, var(--primary) 20%, transparent); }
            50% { box-shadow: 0 0 0 12px color-mix(in oklch, var(--primary) 0%, transparent); }
        }
        ...
        .error-code {
            ...
            line-height: 1;
            background: linear-gradient(135deg, var(--primary), color-mix(in oklch, var(--primary) 60%, oklch(0.8 0.2 200)));
...
<body>
    ...
    <div class="error-icon">
        <i data-lucide="file-search" style="width:2.5rem;height:2.5rem;color:var(--primary);"></i>
    </div>
